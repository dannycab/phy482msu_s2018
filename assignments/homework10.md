...
layout: homework
use_math: true
title: Homework 10 (Due. Apr 6)
---

**Your written homework is shorter this week because the project problem is quite substantive this week as it will can represent the bulk of your project work.**

## 1. Different kinds of conductors

In class, you derived equations for EM waves in conductors, assuming a "good conductor." Interestingly, it turns out that the formulas we got can be pushed a good deal further than you might naively expect, into regimes where e.g.  is not so large ("poor conductors.") In this case, you will need to use Griffiths more careful results for the real and imaginary parts of the k vector and work with those.
...
**You will turn part 5 in using your personal GitHub repository.**
